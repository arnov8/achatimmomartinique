      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-cyan-500 text-white py-12 md:py-16 px-6 print:hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base md:text-xl opacity-95 mb-8 font-medium max-w-2xl">AchatImmoMartinique centralise toutes les annonces immobilières publiées par les principaux professionnels. Plus besoin de multiplier les recherches.</p>
